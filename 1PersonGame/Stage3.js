...
class Player {
    ...
    Slide(){
        ...
        this.characterImg.src="../characterImg/Slide3_0.png";
    }

    Jump () {
        //console.log("뛰고있습니다.")
        this.characterImg.src="../characterImg/Jump3_0.png";
...
class Obstacle {
    constructor (x, y, w, h) {
        ...
        this.obstacleImg.src="../Stage3Img/bottom.png";
    }
...
backgroundLayer1.src="../Stage3Img/department1.png"
const backgroundLayer2 = new Image()
backgroundLayer2.src="../Stage3Img/department0.png"
const backgroundLayer3 = new Image()
backgroundLayer3.src="../Stage3Img/map3Ground.png"
...
const layer1 = new Layer(backgroundLayer1, 0.2, 1200);
const layer2 = new Layer(backgroundLayer2, 1.0, 960);
...
function SpawnObstacle () {
    ...
    let obstacle;
    if(type===0){
        obstacle = new Obstacle(canvas.width + 100, canvas.height - 100, 100, 100);
        obstacle.obstacleImg.src = "../Stage3Img/bottom.png";
    }else if(type===1){
        obstacle = new Obstacle(canvas.width + 100, 0 , 100, canvas.height-100);
        obstacle.obstacleImg.src = "../Stage3Img/slider.png";
    }else if(type===2){
        obstacle = new Obstacle(canvas.width + 150, canvas.height - 200, 150, 200);
        obstacle.obstacleImg.src = "../Stage3Img/bottom.png";
    }
    ...
    for (let i = 0; i < obstacles.length; i++) {
        ...
        if (
            ...
            player.y + player.h > o.y
                ...
                player.characterImg.src="../characterImg/Die3_0.png"
                obstacles = [];
                score = 0;
