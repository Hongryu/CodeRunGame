...
class Player {
    ...
    Animate () {
        ...
        if (this.y + this.h < canvas.height) {      //바닥에 붙어있지 않으면
            this.dy += gravity;
            this.grounded = false;
        } else {
            this.dy = 0;
...
backgroundLayer1.src="../image/backgroundBack.png"
const backgroundLayer2 = new Image()
backgroundLayer2.src="../image/backgroundFront.png"
...
function SpawnObstacle () {
    ...
    let obstacle;
    if(type===0){
        obstacle = new Obstacle(canvas.width + 20, canvas.height - 20, 20, 20);
        obstacle.obstacleImg.src = "../obstacleImg/obstacle0.png";
    }else if(type===1){
        obstacle = new Obstacle(canvas.width + 40, canvas.height - 20, 40, 20);
        obstacle.obstacleImg.src = "../obstacleImg/obstacle1.png";
    }
    obstacles.push(obstacle);
    console.log(obstacles)
    console.log(obstacle.obstacleImg.src)
}
...
function Start () {
    ...
    player = new Player(25, 0, 100, 130);
    player2 = new Player2(300, 0, 100, 130);
